"""
Train Joint Sync Flow model (Manual + NMM combined)
with resume + best checkpoint saving (Optimized)
"""
import os
import glob
import torch
...
from models.joint_sync_generator import JointSyncFlow
...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default='./checkpoints/joint_sync')
